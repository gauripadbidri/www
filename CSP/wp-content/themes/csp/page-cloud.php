...
<section id="body">
    <div class="container cloud">
        ...
        <section id="datatitle" class="col-lg-12 col-md-12">
              ...
              <?php
                ...
                if ($attachments) {
                 foreach ($attachments as $attachment) {
                  ...
                  echo '<img id="news-img" class="img-responsive" src="'.get_stylesheet_directory_uri().'/images/Cloud_Closed_img1.jpg" />';
                }
            ?>
            ...
            <div style="background-color: #5590cc;" class="col-lg-6 col-md-6 col-sm-12 col-xs-12 imageInfoSection visible-lg visible-md hidden-sm hidden-xs">
                <p>
