...
function _classCallCheck(e, t) {
        ...
        a = function() {
            ...
            return _createClass(e, null, [{
                ...
                value: function(e, t) {
                    ...
                    return -1 !== i.indexOf("with_comma_separator") ? i.replace(n, s).replace(",00", "") : i.replace(n, s).replace(".00", "")
                }
            }, {
                key: "convertAll",
                value: function(e) {
        ...
        r = function() {
            ...
            return _createClass(e, [{
                ...
                value: function(e, t) {
                    ...
                    var i = null,
                        a = null;
                    0 === (i = "INPUT" === t.tagName ? parseInt(Math.max(parseInt(t.value) || 1, 1)) : parseInt(t.getAttribute("data-quantity"))) && (a = t.closest(".CartItemWrapper")), fetch("/cart/change.js", {
                        body: JSON.stringify({
                    ...
                    if (n !== (e ? e.detail.previousBreakpoint : null))
                        if ("phone" === n || "tablet" === n) this.carouselNavScrollSpy && this.carouselNavScrollSpy.destroy(), this.productInfoScroller && this.productInfoScroller.destroy(), this.productThumbnailsScroller && this.productThumbnailsScroller.destroy(), this.productAsideElement ? this.productAsideElement.style.minHeight = null : this.productWrapperElement.style.minHeight = null, this.productInfoElement.parentNode.style.maxHeight = null;
                            ...
                            if (this.slideshowImages && this.slideshowImages.length > 1) {
                                var i = 0;
                                this.options.stackProductImages && (i = this.slideshowNavDots.firstElementChild.offsetTop), this.options.showThumbnails && u.ResponsiveHelper.matchesBreakpoint("desk") && (i = 250), this.carouselNavScrollSpy = new r.default(this.element, this.slideshowImages, {
                            ...
                            var a = window.getComputedStyle(this.productInfoElement),
                                ...
                                s = function() {
                                    t.productAsideElement ? (t.productAsideElement.style.minHeight = t.productInfoElement.scrollHeight - o + "px", t.productInfoElement.closest(".Product__InfoWrapper").style.maxHeight = t.productAsideElement.offsetTop + t.productInfoElement.scrollHeight - o + "px") : t.productWrapperElement.style.minHeight = t.productInfoElement.scrollHeight - parseInt(a.paddingTop) + "px"
                                };
                    ...
                    if (!n.classList.contains("is-selected")) {
                        ...
                        fastdom.measure(function() {
                            ...
                            if (a = n < e) {
                                var i = t.offsetLeft,
                                    r = null,
                                    l = (r = i <= n - (i + t.offsetWidth) ? t.previousElementSibling || t : t.nextElementSibling || t).offsetLeft - o.scrollLeft,
                                    c = l + r.offsetWidth;
                                c > n ? s = c - n : l < 0 && (s = l)
                            }
                        }), fastdom.mutate(function() {
    ...
    ! function() {
        ...
        r.register("header", o.HeaderSection), r.register("sidebar-menu", o.SidebarMenuSection), r.register("cart", o.CartSection), r.register("newsletter-popup", o.NewsletterPopupSection), r.register("slideshow", o.SlideshowSection), r.register("collection-list", o.CollectionListSection), r.register("article-list", o.ArticleListSection), r.register("featured-product", o.FeaturedProductSection), r.register("image-with-text-block", o.ImageWithTextBlockSection), r.register("timeline", o.TimelineSection), r.register("instagram", o.InstagramSection), r.register("map", o.MapSection), r.register("featured-collections", o.FeaturedCollectionsSection), r.register("shop-the-look", o.ShopTheLookSection), r.register("testimonials", o.TestimonialsSection), r.register("background-video", o.BackgroundVideoSection), r.register("product", o.ProductSection), r.register("related-products", o.RelatedProductsSection), r.register("collection", o.CollectionSection), r.register("article-list", o.ArticleListSection), r.register("article", o.ArticleSection), r.register("faq", o.FaqSection), r.register("login", o.LoginSection), r.register("addresses", o.AddressesSection), r.register("gift-card", o.GiftCardSection), r.register("search", o.SearchSection), r.register("recently-viewed-products", o.RecentlyViewedProductsSection), r.register("shop-now", o.ShopNowSection),
            ...
            }), e = new domDelegate.Delegate(document.body), t = document.querySelector(".AnnouncementBar"), e.on("click", '[href^="#"], [data-href]', function(e, n) {
            ...
            }), n = window.innerWidth, s = document.getElementById("shopify-section-header"), window.addEventListener("resize", function() {
                var e = -1;
                fastdom.measure(function() {
                    e = window.innerWidth
                }), fastdom.mutate(function() {
                    e !== n && (n = e, document.documentElement.style.setProperty("--window-height", window.innerHeight + "px"), s && document.documentElement.style.setProperty("--header-height", s.clientHeight + "px"))
                })
            }),
            function() {
